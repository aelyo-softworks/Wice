...
namespace Wice
{
    ...
    {
        public static VisualProperty ModeProperty = VisualProperty.Add(typeof(ScrollBar), nameof(Mode), VisualPropertyInvalidateModes.Measure, ScrollBarMode.Standard);
