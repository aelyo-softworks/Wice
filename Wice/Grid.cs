...
namespace Wice
{
    ...
    {
        public static VisualProperty RowProperty = VisualProperty.Add(typeof(Grid), "Row", VisualPropertyInvalidateModes.Measure, 0, convert: ValidateRowCol);
        public static VisualProperty ColumnProperty = VisualProperty.Add(typeof(Grid), "Column", VisualPropertyInvalidateModes.Measure, 0, convert: ValidateRowCol);
        public static VisualProperty RowSpanProperty = VisualProperty.Add(typeof(Grid), "RowSpan", VisualPropertyInvalidateModes.Measure, 1, convert: ValidateSpan);
        public static VisualProperty ColumnSpanProperty = VisualProperty.Add(typeof(Grid), "ColumnSpan", VisualPropertyInvalidateModes.Measure, 1, convert: ValidateSpan);
        ...
        protected override D2D_SIZE_F MeasureCore(D2D_SIZE_F constraint)
        {
            ...
            _childrenByDimensions = new Dictionary<GridDimension, List<Visual>>();
        ...
        private sealed class GridSet
        {
            ...
            {
                var gs = new GridSet();
                gs.ColIndex = Math.Max(0, Math.Min(grid.Columns.Count - 1, GetColumn(visual)));
