...
namespace Wice
{
    ...
    {
        public static VisualProperty RadiusProperty = VisualProperty.Add(typeof(Ellipse), nameof(Radius), VisualPropertyInvalidateModes.Render, new Vector2());
        public static VisualProperty RadiusOffsetProperty = VisualProperty.Add(typeof(Ellipse), nameof(RadiusOffset), VisualPropertyInvalidateModes.Render, new Vector2());
