...
namespace Wice
{
    ...
    public abstract class GridDimension : BaseObject
    {
        ...
        public static BaseObjectProperty StarsProperty = BaseObjectProperty.Add(typeof(GridDimension), nameof(Stars), 1f, convert: ValidateStars);
        public static BaseObjectProperty SizeProperty = BaseObjectProperty.Add(typeof(GridDimension), nameof(Size), 0f, convert: ValidateSize); // TODO: float.nan?
        public static BaseObjectProperty MinSizeProperty = BaseObjectProperty.Add(typeof(GridDimension), nameof(MinSize), 0f, convert: ValidateMinMaxSize);
        public static BaseObjectProperty MaxSizeProperty = BaseObjectProperty.Add(typeof(GridDimension), nameof(MaxSize), float.MaxValue, convert: ValidateMinMaxSize);
        public static BaseObjectProperty DefaultAlignmentProperty = BaseObjectProperty.Add<Alignment?>(typeof(GridDimension), nameof(DefaultAlignment));
