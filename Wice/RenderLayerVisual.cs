...
namespace Wice
{
    ...
    {
        public static VisualProperty RenderEffectProperty = VisualProperty.Add<CompositionEffectBrush>(typeof(Visual), nameof(RenderEffect), VisualPropertyInvalidateModes.Render);
