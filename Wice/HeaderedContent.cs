...
namespace Wice
{
    public class HeaderedContent : Stack, IOneChildParent
    {
        ...
        protected virtual ScrollViewer CreateViewer() => new ScrollViewer();
        protected override BaseObjectCollection<Visual> CreateChildren() => new BaseObjectCollection<Visual>(2);
