...
namespace Wice
{
    ...
    {
        public static VisualProperty ColumnsProperty = VisualProperty.Add(typeof(UniformGrid), nameof(Columns), VisualPropertyInvalidateModes.Measure, 0);
        public static VisualProperty RowsProperty = VisualProperty.Add(typeof(UniformGrid), nameof(Rows), VisualPropertyInvalidateModes.Measure, 0);
        public static VisualProperty RowsLineWidthProperty = VisualProperty.Add(typeof(UniformGrid), nameof(RowsLineWidth), VisualPropertyInvalidateModes.Measure, 0f);
        public static VisualProperty ColumnsLineWidthProperty = VisualProperty.Add(typeof(UniformGrid), nameof(ColumnsLineWidth), VisualPropertyInvalidateModes.Measure, 0f);
        public static VisualProperty LineStrokeWidthProperty = VisualProperty.Add(typeof(UniformGrid), nameof(LineStrokeWidth), VisualPropertyInvalidateModes.Measure, 0f);
        public static VisualProperty LineStrokeStyleProperty = VisualProperty.Add<D2D1_STROKE_STYLE_PROPERTIES?>(typeof(UniformGrid), nameof(LineStrokeStyle), VisualPropertyInvalidateModes.Render);
        public static VisualProperty LineBrushProperty = VisualProperty.Add<Brush>(typeof(UniformGrid), nameof(LineBrush), VisualPropertyInvalidateModes.Render);
