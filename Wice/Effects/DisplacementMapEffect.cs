...
namespace Wice.Effects
{
    ...
    {
        public static EffectProperty ScaleProperty = EffectProperty.Add(typeof(DisplacementMapEffect), nameof(Scale), 0, 0f);
        public static EffectProperty XChannelSelectProperty = EffectProperty.Add(typeof(DisplacementMapEffect), nameof(XChannelSelect), 1, D2D1_CHANNEL_SELECTOR.D2D1_CHANNEL_SELECTOR_A);
        public static EffectProperty YChannelSelectProperty = EffectProperty.Add(typeof(DisplacementMapEffect), nameof(YChannelSelect), 2, D2D1_CHANNEL_SELECTOR.D2D1_CHANNEL_SELECTOR_A);
