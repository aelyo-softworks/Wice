...
namespace Wice.Effects
{
    ...
    public class VignetteEffect : EffectWithSource
    {
        ...
        {
            ColorProperty = EffectProperty.Add(typeof(VignetteEffect), nameof(Color), 0, GRAPHICS_EFFECT_PROPERTY_MAPPING.GRAPHICS_EFFECT_PROPERTY_MAPPING_COLOR_TO_VECTOR4, _D3DCOLORVALUE.Black);
