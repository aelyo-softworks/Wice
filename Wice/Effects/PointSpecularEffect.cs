...
namespace Wice.Effects
{
    ...
    {
        public static EffectProperty LightPositionProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(LightPosition), 0, new D2D_VECTOR_3F());
        public static EffectProperty SpecularExponentProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(SpecularExponent), 1, 1f);
        public static EffectProperty SpecularConstantProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(SpecularConstant), 2, 1f);
        public static EffectProperty SurfaceScaleProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(SurfaceScale), 3, 1f);
        public static EffectProperty ColorProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(Color), 4, GRAPHICS_EFFECT_PROPERTY_MAPPING.GRAPHICS_EFFECT_PROPERTY_MAPPING_COLOR_TO_VECTOR3, new D2D_VECTOR_3F(1f, 1f, 1f));
        public static EffectProperty KernelUnitLengthProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(KernelUnitLength), 5, new D2D_VECTOR_2F(1f, 1f));
        public static EffectProperty ScaleModeProperty = EffectProperty.Add(typeof(PointSpecularEffect), nameof(ScaleMode), 6, D2D1_POINTDIFFUSE_SCALE_MODE.D2D1_POINTDIFFUSE_SCALE_MODE_LINEAR);
