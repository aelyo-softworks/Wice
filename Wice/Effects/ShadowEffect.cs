...
namespace Wice.Effects
{
    ...
    {
        public static EffectProperty BlurStandardDeviationProperty = EffectProperty.Add(typeof(ShadowEffect), nameof(BlurStandardDeviation), 0, 3f);
        public static EffectProperty ColorProperty = EffectProperty.Add(typeof(ShadowEffect), nameof(Color), 0, GRAPHICS_EFFECT_PROPERTY_MAPPING.GRAPHICS_EFFECT_PROPERTY_MAPPING_COLOR_TO_VECTOR4, new _D3DCOLORVALUE(1, 0, 0, 0));
        public static EffectProperty OptimizationProperty = EffectProperty.Add(typeof(ShadowEffect), nameof(Optimization), 0, D2D1_SHADOW_OPTIMIZATION.D2D1_SHADOW_OPTIMIZATION_BALANCED);
