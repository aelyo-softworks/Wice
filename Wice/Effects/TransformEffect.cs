...
namespace Wice.Effects
{
    ...
    {
        public static EffectProperty InterpolationModeProperty = EffectProperty.Add(typeof(TransformEffect), nameof(InterpolationMode), 0, D2D1_3DTRANSFORM_INTERPOLATION_MODE.D2D1_3DTRANSFORM_INTERPOLATION_MODE_LINEAR);
        public static EffectProperty BorderModeProperty = EffectProperty.Add(typeof(TransformEffect), nameof(BorderMode), 1, D2D1_BORDER_MODE.D2D1_BORDER_MODE_SOFT);
        public static EffectProperty TransformMatrixProperty = EffectProperty.Add(typeof(TransformEffect), nameof(TransformMatrix), 2, new D2D_MATRIX_4X4_F(1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f, 0f, 0f, 0f, 0f, 1f));
