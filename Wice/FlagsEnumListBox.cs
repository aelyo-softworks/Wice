...
namespace Wice
{
    ...
    {
        public static VisualProperty ValueProperty = VisualProperty.Add<object>(typeof(FlagsEnumListBox), nameof(Value), VisualPropertyInvalidateModes.Measure, convert: EnumTypeCheck);
