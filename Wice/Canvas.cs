...
namespace Wice
{
    ...
    {
        public static VisualProperty MeasureToContentProperty = VisualProperty.Add(typeof(Window), nameof(Canvas), VisualPropertyInvalidateModes.Measure, DimensionOptions.Manual);

        // review: invalidate measure or arrange?
        public static VisualProperty LeftProperty = VisualProperty.Add(typeof(Canvas), "Left", VisualPropertyInvalidateModes.ParentMeasure, float.NaN);
        public static VisualProperty TopProperty = VisualProperty.Add(typeof(Canvas), "Top", VisualPropertyInvalidateModes.ParentMeasure, float.NaN);
        public static VisualProperty RightProperty = VisualProperty.Add(typeof(Canvas), "Right", VisualPropertyInvalidateModes.ParentMeasure, float.NaN);
        public static VisualProperty BottomProperty = VisualProperty.Add(typeof(Canvas), "Bottom", VisualPropertyInvalidateModes.ParentMeasure, float.NaN);
