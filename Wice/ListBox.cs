...
namespace Wice
{
    ...
    {
        public static VisualProperty DataSourceProperty = VisualProperty.Add<object>(typeof(ListBox), nameof(DataSource), VisualPropertyInvalidateModes.Measure);
        public static VisualProperty DataItemMemberProperty = VisualProperty.Add<string>(typeof(ListBox), nameof(DataItemMember), VisualPropertyInvalidateModes.Measure, convert: NullifyString);
        public static VisualProperty DataItemFormatProperty = VisualProperty.Add<string>(typeof(ListBox), nameof(DataItemFormat), VisualPropertyInvalidateModes.Measure, convert: NullifyString);
        public static VisualProperty DataBinderProperty = VisualProperty.Add<DataBinder>(typeof(ListBox), nameof(DataBinder), VisualPropertyInvalidateModes.Measure);
        public static VisualProperty IntegralHeightProperty = VisualProperty.Add(typeof(ListBox), nameof(IntegralHeight), VisualPropertyInvalidateModes.Measure, false);
        public static VisualProperty SelectionModeProperty = VisualProperty.Add(typeof(ListBox), nameof(SelectionMode), VisualPropertyInvalidateModes.Arrange, SelectionMode.Single);
        ...
        {
            if (!(Parent?.Parent is ScrollViewer sv))
                return false;
        ...
        protected virtual void BindDataItemVisual(DataBindContext context)
        {
            ...
            if (!(context.DataVisual is TextBox tb))
                return;
        ...
        protected virtual ItemVisual NewItemVisual() => new ItemVisual();
