...
namespace Wice
{
    ...
    {
        public static VisualProperty OrientationProperty = VisualProperty.Add(typeof(Stack), nameof(Orientation), VisualPropertyInvalidateModes.Measure, Orientation.Vertical);
        public static VisualProperty LinesSizeProperty = VisualProperty.Add(typeof(Stack), nameof(LinesSize), VisualPropertyInvalidateModes.Measure, 0f);
        public static VisualProperty LastChildFillProperty = VisualProperty.Add(typeof(Stack), nameof(LastChildFill), VisualPropertyInvalidateModes.Measure, true);
        public static VisualProperty SpacingProperty = VisualProperty.Add(typeof(Stack), nameof(Spacing), VisualPropertyInvalidateModes.Measure, new D2D_SIZE_F());
