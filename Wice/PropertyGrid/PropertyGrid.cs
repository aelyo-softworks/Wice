...
namespace Wice.PropertyGrid
{
    ...
    {
        public static VisualProperty LiveSyncProperty = VisualProperty.Add(typeof(PropertyGrid), nameof(LiveSync), VisualPropertyInvalidateModes.Render, false);
        public static VisualProperty IsReadOnlyProperty = VisualProperty.Add(typeof(PropertyGrid), nameof(IsReadOnly), VisualPropertyInvalidateModes.Render, false);
        public static VisualProperty GroupByCategoryProperty = VisualProperty.Add(typeof(PropertyGrid), nameof(GroupByCategory), VisualPropertyInvalidateModes.Render, false);
        public static VisualProperty SelectedObjectProperty = VisualProperty.Add<object>(typeof(PropertyGrid), nameof(SelectedObject), VisualPropertyInvalidateModes.Measure, null);
        public static VisualProperty CellMarginProperty = VisualProperty.Add(typeof(PropertyGrid), nameof(CellMargin), VisualPropertyInvalidateModes.Measure, new D2D_RECT_F());
