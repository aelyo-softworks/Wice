...
namespace Wice.PropertyGrid
{
    ...
    {
        public static VisualProperty NameProperty = VisualProperty.Add<string>(typeof(PropertyGridCategory), nameof(Name), VisualPropertyInvalidateModes.Render, null);
        public static VisualProperty DisplayNameProperty = VisualProperty.Add<string>(typeof(PropertyGridCategory), nameof(DisplayName), VisualPropertyInvalidateModes.Render);
        public static VisualProperty IsExpandedProperty = VisualProperty.Add(typeof(PropertyGridCategory), nameof(IsExpanded), VisualPropertyInvalidateModes.Render, false);
        public static VisualProperty SortOrderProperty = VisualProperty.Add(typeof(PropertyGridCategory), nameof(SortOrder), VisualPropertyInvalidateModes.Render, 0);
