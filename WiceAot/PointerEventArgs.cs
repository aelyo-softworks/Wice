...
public abstract class PointerEventArgs(uint pointerId) : HandledEventArgs
{
    ...
    public POINTER_INPUT_TYPE PointerType { get { WiceCommons.GetPointerType(PointerId, out var type); return type; } }
    public POINTER_INFO PointerInfo { get { WiceCommons.GetPointerInfo(PointerId, out var info); return info; } }
    public POINTER_PEN_INFO PointerPenInfo { get { WiceCommons.GetPointerPenInfo(PointerId, out var info); return info; } }
    public POINTER_TOUCH_INFO PointerTouchInfo { get { WiceCommons.GetPointerTouchInfo(PointerId, out var info); return info; } }
