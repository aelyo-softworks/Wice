...
public class TextBoxSampleList : SampleList
{
    ...
    public override string SubTitle => "A single-line or multi-line, read-only or read-write, text field supporting Direct Write features.";
    ...
    protected override IEnumerable<Sample> Types
    {
        get
        {
            ...
            yield return new FormattedTextBoxSample();
