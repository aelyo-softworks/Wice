...
public class RadioButtonsSample : Sample
{
    ...
    public override void Layout(Visual parent)
    {
        ...
        var thickness = parent.Window!.DipsToPixels(10);
        var rb0 = new Wice.RadioButton { Name = "button 0", Margin = D2D_RECT_F.Thickness(thickness, 0) };
        dock.Children.Add(rb0);

        var rb1 = new Wice.RadioButton { Name = "button 1", Margin = D2D_RECT_F.Thickness(thickness, 0) };
        dock.Children.Add(rb1);

        var rb2 = new Wice.RadioButton { Name = "button 2", Margin = D2D_RECT_F.Thickness(thickness, 0) };
        dock.Children.Add(rb2);

        // add results textbox
        var results = new TextBox { Margin = D2D_RECT_F.Thickness(thickness, 0) };
