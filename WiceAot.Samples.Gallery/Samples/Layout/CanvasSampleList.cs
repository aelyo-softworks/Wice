...
public class CanvasSampleList : SampleList
{
    ...
    public override string Description => "The Canvas provides absolute positioning of controls or content. Content is positioned relative to the Canvas using the Canvas.Top, Left Right and Bottom properties.";
