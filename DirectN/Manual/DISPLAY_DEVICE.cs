...
namespace DirectN
{
    ...
    public struct DISPLAY_DEVICE
    {
        ...
        public override string ToString() => "Name=" + DeviceName + ", String=" + DeviceString + ", Id=" + DeviceID + ", Key=" + DeviceKey + ", Flags=" + StateFlags;
        ...
        public DEVMODE CurrentSettings
        {
            get
            {
                ...
                EnumDisplaySettings(DeviceName, ENUM_CURRENT_SETTINGS, ref mode, 0);
                return mode;
            }
        }
        ...
        public DEVMODE RegistrySettings
        {
            get
            {
                ...
                var mode = new DEVMODE();
                EnumDisplaySettings(DeviceName, ENUM_REGISTRY_SETTINGS, ref mode, 0);
                return mode;
            }
        }
